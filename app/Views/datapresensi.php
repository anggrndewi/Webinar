...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <li class="nav-item">
        <a class="nav-link" href="data_presensi.html">
...
<p class="mb-4">Berikut ini adalah data presensi peserta webinar.</p>

<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Data Presensi Webinar</h6>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2023-07-12 09:15:00</td>
                        <td>Hadir</td>
                    </tr>
                    <tr>
                        <td>Jane Smith</td>
                        <td>janesmith@example.com</td>
                        <td>2023-07-12 09:20:00</td>
                        <td>Hadir</td>
                    </tr>
                    <tr>
                        <td>Michael Johnson</td>
                        <td>michaeljohnson@example.com</td>
                        <td>2023-07-12 09:25:00</td>
                        <td>Hadir</td>
                    </tr>
                    <tr>
                        <td>Sarah Lee</td>
                        <td>sarahlee@example.com</td>
                        <td>2023-07-12 09:30:00</td>
                        <td>Belum Hadir</td>
                    </tr>
                </tbody>
            </table>
